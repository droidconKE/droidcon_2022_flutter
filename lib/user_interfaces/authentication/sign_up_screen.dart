...
import 'widgets/signup_image_background.dart';
            ...
            child: SingleChildScrollView(
              child: Column(
                children: [
                  ...
                  const AppTextField(name: 'username', hint: 'Username'),
                  const SizedBox(height: 20),
                  const AppTextField(name: 'email', hint: 'Email address'),
                  const SizedBox(height: 20),
                  const AppTextField(name: 'password', hint: 'Password'),
                  const SizedBox(height: 20),
                  const AppTextField(
