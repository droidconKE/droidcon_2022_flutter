...
_$_Session _$$_SessionFromJson(Map<String, dynamic> json) => _$_Session(
      ...
      isKeynote: json['is_keynote'] as bool?,
      sessionImage: json['session_image'] as String?,
      backgroundColor: json['backgroundColor'] as String?,
      borderColor: json['borderColor'] as String?,
      isServiceSession: json['is_serviceSession'] as bool?,
...
Map<String, dynamic> _$$_SessionToJson(_$_Session instance) =>
    <String, dynamic>{
      ...
      'is_keynote': instance.isKeynote,
      'session_image': instance.sessionImage,
      'backgroundColor': instance.backgroundColor,
      'borderColor': instance.borderColor,
      'is_serviceSession': instance.isServiceSession,
